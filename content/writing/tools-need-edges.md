...
struct:
  ...
  sections:
    - label: "Preamble"
      concepts: ["possibility space", "orientation"]
    - label: "Thesis"
      concepts: ["edges", "constraints"]
    - label: "Turn"
      concepts: ["AI", "generative"]
    - label: "Closing"
      concepts: ["holdable", "humans"]
---

> [aside|A tool without constraints is not liberating. It is unfinished.]
>
