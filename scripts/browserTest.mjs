...
ab('wait 1200');
const txt = pageText();
assert('constellation overlay', txt.includes('inside the argument') && txt.includes('back to the field'));
assert('constellation lens title', txt.includes('understanding after the right omissions'));
