  ...
  return (
    <main className="grid h-screen place-items-center bg-paper px-6 text-ink">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex rounded-full border border-accent/50 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.12em] transition hover:border-accent-ink"
        >
          home
        </Link>
      </div>
