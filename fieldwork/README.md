...
A second operating premise now governs scale:
...
blind scout frontier
  ↓
promotion into native branches
  ↓
native source passes
  ↓
internal stress
  ↓
collisions
...
probes / contact
  ↓
source-closed synthesis
  ↓
revision of the seed, if earned
```

Synthesis is intentionally late.
...
A source is worth recording because it is interesting. It is allowed to move the map only when it creates displacement:

- a distinction we lacked;
- a contradiction or weakened edge;
- a prediction or discriminating consequence;
- an intervention/probe;
- a better explanation of a live anomaly;
...
A **progress unit** is a new question, distinction, discriminating consequence, intervention, or claim we can no longer honestly hold.
...
The goal is not to make Geometry larger. It is to discover whether Geometry survives.
